...
public class CEducacion {
 ...
 @Autowired
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion) {
        ...
        Educacion educacion = new Educacion(dtoeducacion.getNombreEducacion(), dtoeducacion.getDescripcionEducacion(), dtoeducacion.getComienzo(), dtoeducacion.getFinalizacion());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion) {
        ...
        if (sEducacion.existsByNombreEducacion(dtoeducacion.getNombreEducacion()) && sEducacion.getByNombreExperiencia(dtoeducacion.getNombreEducacion()).get().getId() != id) {
            return new ResponseEntity(new Mensaje("Esa Educacion ya existe "), HttpStatus.BAD_REQUEST);
        }
        if (StringUtils.isBlank(dtoeducacion.getNombreEducacion()))
            return new ResponseEntity(new Mensaje ("El nombre es obligatorio"),HttpStatus.BAD_REQUEST);
       ...
       educacion.setComienzo(dtoeducacion.getComienzo());
       educacion.setFinalizacion(dtoeducacion.getFinalizacion());
